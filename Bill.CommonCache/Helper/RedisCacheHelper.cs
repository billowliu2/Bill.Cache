...
namespace Bill.CommonCache.Helper
{
   
    public class RedisCacheHelper : IDisposable
    {
        ...
        public RedisCacheHelper()
        {
            ...
            _cacheOptions = new JsonConfigurationHelper().Get<CacheOptions>("Cache", "", true);

            _redis = ConnectionMultiplexer.Connect(_cacheOptions.Redis.ConnectionString);
            Db = _redis.GetDatabase();
            _prefix = _cacheOptions.Redis.Prefix ?? string.Empty;
        }
